...
public class SetAzureBindingAction extends SetBindingAlmSettingsWsAction {
    ...
    public void define(WebService.NewController context) {
        WebService.NewAction action = context.createAction("set_azure_binding").setPost(true).setHandler(this);
