...
public class CreateBitBucketAction extends AlmSettingsWsAction {
    ...
    public void define(WebService.NewController context) {
        WebService.NewAction action = context.createAction("create_bitbucket").setPost(true).setHandler(this);
    ...
    public void handle(Request request, Response response) {
        ...
        try (DbSession dbSession = dbClient.openSession(false)) {
            ...
            dbClient.almSettingDao().insert(dbSession, new AlmSettingDto().setAlm(BITBUCKET).setKey(key).setUrl(url)
