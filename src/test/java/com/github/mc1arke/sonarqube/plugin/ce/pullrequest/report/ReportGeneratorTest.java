...
class ReportGeneratorTest {
    ...
    void shouldProduceCorrectAnalysisSummary(String coverage, String coverageImage, String duplications, String duplicationsImage) {
        ...
        AnalysisSummary expected = AnalysisSummary.builder()
                        ...
                        .withNewIssues(new AnalysisSummary.UrlIconMetric<>("http://localhost:9000/project/issues?id=projectKey&pullRequest=5&resolved=false", "http://localhost:9000/static/communityBranchPlugin/common/failed-16px.png", 5L))
