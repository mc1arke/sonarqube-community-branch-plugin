...
public class UpdateBitbucketCloudActionTest {
    ...
    public void testConfigureAction() {
        ...
        UpdateBitbucketCloudAction testCase = new UpdateBitbucketCloudAction(dbClient, userSession);
    ...
    public void testUpdateAlmSettingsDto() {
        ...
        assertThat(result).isEqualToComparingFieldByField(new AlmSettingDto().setKey("originalKey").setClientId("clientId").setClientSecret("clientSecret").setAppId("workspace"));
    }
}
